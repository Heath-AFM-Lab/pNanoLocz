...
from UI_components.RHS_Components.Video_Player_Components import VideoControlWidget, VideoDepthControlWidget, VisualRepresentationWidget, ExportAndVideoScaleWidget, VispyVideoPlayerWidget
...
class VideoPlayerWidget(QWidget):
    ...
    def loadFrames(self):
        ...
        self.vispyVideoPlayerWidget.update_widgets.connect(self.update_frame)
        # self.videoPlayerLayout.addStretch(1)
        ...
        self.videoPlayerLayout.addSpacing(10)
        self.videoPlayerLayout.addWidget(self.colorbarCanvas.native)
